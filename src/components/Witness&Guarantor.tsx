...
export const WitnessAndGuarantor: React.FC = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            {
                wantWitness === false ?
                    <button type="button" className="bg-blue-800 hover:bg-blue-700 text-white font-bold font-sans p-4 text-lg md:text-xl" onClick={() => setWantWitness(true)}>Add Witness(Optional)</button>
                : <Witness />
            }

            {
                wantGuarantor === false ?
                    <button type="button" className="bg-blue-800 hover:bg-blue-700 text-white font-bold font-sans p-4 text-lg md:text-xl" onClick={() => setWantGuarantor(true)}>Add Guarantor(Optional)</button>
                : <Guarantor />
            }
